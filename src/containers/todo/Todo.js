...
export class Todo extends React.Component{
	...
	<form className="col-xs-12 col-md-2">
		...
		<div className="form-group">
			...
			<select className="form-control" id="dateFilter" type="text" name="dateFilter">
    		<option value=""></option>
			<option></option>
		</select>
		</div>
	...
	<div className="col-xs-12 col-md-10 todo-list_wrapper">
		<div className="row">
			{this.props.todo.filter(f => (f.title.includes(this.props.filterString) || f.description.includes(this.props.filterString)) ).map((e, i)=>
...
//	
//	</div>
//				<button type="submit" className="btn btn-default" onClick={()=>console.log('click')}>Submit</button>
//			</form>
//		</div>
//	</div>
//</section>
...
//		<div className="form-group">
//			<label htmlFor="titleFilter"> Title</label>
//			<input type="text" className="form-control" id="titleFilter" name="titleFilter" placeholder="Title" onChange={(e => props.changeFilter(e.target.value))} />
//		</div>
//		<div className="form-group">
//			<label htmlFor="dateFilter">Date</label>
//			<select className="form-control" id="dateFilter" type="text" name="dateFilter">
...
//	<div className="col-xs-12 col-md-10 todo-list_wrapper">
//		<div className="row">
//			{props.todo.filter(f => (f.title.includes(props.filterString) || f.description.includes(props.filterString)) ).map((e, i)=>
//			<div className="col-xs-6 col-md-4 col-lg-3 todo-item" key={i}>
//				<a className="delBtn"><span onClick={()=> props.deleteTodo(e.id)} className="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
//				<h3>{e.title}</h3>
//				<div>{e.description}</div>
//				<span>{e.created_at}</span>
//			</div> )}
